...
module.exports = function (server) {
	 ...
	 * requestor.
	 *
	 * @name Get reactions to a comment for a user's post as JSON object or as an HTML page
	 * @route {GET} /:username/post/:postId/comment/commentId/reactions[.json]
	 ...
	 * @routeparam {String} :commentId Id of wanted comment
	 ...
	 * @returns {JSON|HTML} If .json is requested returns an array of JSON reaction objects, otherwise HTML
	 */
